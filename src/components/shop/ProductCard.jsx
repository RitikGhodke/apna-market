...
//       {/* Image */}
//       <div className="h-44 bg-white relative overflow-hidden flex items-center justify-center">
//         {product.images && product.images[0] ? (
//           <img
...
export default function ProductCard({ product }) {
  ...
  return (
    <Link
      ...
      className="block bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-200 active:scale-95">
      ...
      <div className="h-44 bg-white relative overflow-hidden flex items-center justify-center">
        ...
        {product.offerPercent > 0 && (
          <div className="absolute top-2 right-2 bg-red-500 text-white text-[10px] font-black px-2 py-0.5 rounded-lg">
      ...
      <div className="p-3 border-t border-gray-50">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <span className="text-base font-black text-gray-900">₹{finalPrice}</span>
            {product.offerPrice && (
